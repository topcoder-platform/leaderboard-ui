...
class AlgorithmLeaderboard extends React.Component {
  render () {
    return (
      <LeaderboardLayout
        {...this.props}
...
AlgorithmLeaderboard.getInitialProps = async function () {
  const data = await import('../static/json/algorithm-leaderboard.json')
...
export default AlgorithmLeaderboard
